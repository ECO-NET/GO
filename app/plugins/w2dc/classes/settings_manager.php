...
class w2dc_settings_manager {
	...
	public function plugin_settings() {
		global $w2dc_instance, $w2dc_social_services, $w2dc_maps_styles, $sitepress;
									...
									'fields' => array(
									 	...
									 	array(
											...
											'label' => __('Ratings addon', 'W2DC'),
									 		'description' => __('Ability to place ratings for listings, then manage these ratings by listings owners.', 'W2DC'),
								...
								'listings' => array(
									...
									'fields' => array(
										array(
											...
											'label' => __('Show listings on index page', 'W2DC'),
										...
										array(
											...
											'label' => __('Priority of opening of listing tabs', 'W2DC'),
									 		'items' => $listings_tabs,
											'description' => __('What tab to be opened first on single listing page.'),
								...
								'search' => array(
									...
									'fields' => array(
										...
										array(
											...
											'label' => __('Enable categories search', 'W2DC'),
											'default' => get_option('w2dc_show_categories_search'),
										),
										array(
											'type' => 'slider',
											'name' => 'w2dc_categories_search_nesting_level',
											'label' => __('Categories search depth level', 'W2DC'),
											'min' => 1,
											'max' => 3,
											'default' => get_option('w2dc_categories_search_nesting_level'),
										),
										array(
											'type' => 'toggle',
											'name' => 'w2dc_show_keywords_search',
											'label' => __('Enable keywords search', 'W2DC'),
											'default' => get_option('w2dc_show_keywords_search'),
										),
										array(
											'type' => 'toggle',
											'name' => 'w2dc_keywords_ajax_search',
											'label' => __('Enable listings autosuggestions by keywords', 'W2DC'),
											'default' => get_option('w2dc_keywords_ajax_search'),
										),
										array(
											'type' => 'textbox',
											'name' => 'w2dc_keywords_search_examples',
											'label' => __('Keywords examples', 'W2DC'),
											'description' => __('Comma-separated list of suggestions to try to search', 'W2DC'),
											'default' => get_option('w2dc_keywords_search_examples'),
										),
										array(
											'type' => 'toggle',
											'name' => 'w2dc_show_locations_search',
											'label' => __('Enable locations search', 'W2DC'),
											'default' => get_option('w2dc_show_locations_search'),
										),
										array(
											'type' => 'slider',
											'name' => 'w2dc_locations_search_nesting_level',
											'label' => __('Locations search depth level', 'W2DC'),
											'min' => 1,
											'max' => 3,
											'default' => get_option('w2dc_locations_search_nesting_level'),
										),
										array(
											'type' => 'toggle',
											'name' => 'w2dc_show_address_search',
											'label' => __('Enable address search', 'W2DC'),
										...
										array(
											'type' => 'toggle',
											'name' => 'w2dc_hide_empty_locations',
											'label' => __('Hide empty locations', 'W2DC'),
											'description' => __('This setting is actual for main search block, search widget and locations menus', 'W2DC'),
											'default' => get_option('w2dc_hide_empty_locations'),
										),
										array(
											'type' => 'toggle',
										...
										array(
											'type' => 'toggle',
											'name' => 'w2dc_hide_empty_categories',
											'label' => __('Hide empty categories', 'W2DC'),
											'description' => __('This setting is actual for main search block, search widget and categories menus', 'W2DC'),
											'default' => get_option('w2dc_hide_empty_categories'),
										),
										array(
											'type' => 'toggle',
											'name' => 'w2dc_show_radius_search',
											'label' => __('Show locations radius search', 'W2DC'),
											'description' => sprintf(__('Check geolocation <a href="%s">response</a>.', 'W2DC'), admin_url('admin.php?page=w2dc_debug')),
										...
										array(
											...
											'description' => __('If you have problems with radius search: check your server google API key and enabled APIs. ', 'W2DC') . ' ' . sprintf(__('Check geolocation <a href="%s">response</a>.', 'W2DC'), admin_url('admin.php?page=w2dc_debug')),
									...
									'fields' => array(
										...
										array(
									 	...
									 	array(
											...
											'label' => __('Default Google Maps zoom level (for submission page)', 'W2DC'),
									 		'min' => 1,
									 		'max' => 19,
										...
										array(
											'type' => 'toggle',
											'name' => 'w2dc_google_maps_required',
											'label' => __('Make map markers mandatory during submission of listings', 'W2DC'),
											'default' => get_option('w2dc_google_maps_required'),
										),
										array(
											'type' => 'toggle',
										...
										array(
											...
											'label' => __('Default zoom level', 'W2GM'),
											'items' => array(
												array(
													'value' => '0',
													'label' =>__('Auto', 'W2DC'),
									...
									'fields' => array(
										array(
									 	...
									 	array(
											...
											'label' => __('Show search form and listings panel on the map', 'W2DC'),
								...
								'notifications' => array(
									...
									'fields' => array(
										array(
											...
											'label' => __('This email will be used for notifications to admin and in "From" field. Required to send emails.', 'W2DC'),
								...
								'google_api' => array(
									...
									'fields' => array(
										array(
											...
											'description' => sprintf(__('get your Google API key <a href="%s" target="_blank">here</a>, following APIs must be enabled in the console: Google Maps Directions API, Google Maps JavaScript API and Google Static Maps API.', 'W2DC'), 'https://console.developers.google.com/flows/enableapi?apiid=maps_backend,directions_backend,static_maps_backend&keyType=CLIENT_SIDE&reusekey=true'),
										...
										array(
											...
											'description' => sprintf(__('get your Google API key <a href="%s" target="_blank">here</a>, following APIs must be enabled in the console: Google Maps Geocoding API and Google Places API Web Service.', 'W2DC'), 'https://console.developers.google.com/flows/enableapi?apiid=geocoding_backend,places_backend&keyType=CLIENT_SIDE&reusekey=true') . ' ' . sprintf(__('Then check geolocation <a href="%s">response</a>.', 'W2DC'), admin_url('admin.php?page=w2dc_debug')),
							...
							'controls' => array(
								...
								'search_colors' => array(
									...
									'fields' => array(
										array(
											'type' => 'color',
											'name' => 'w2dc_search_bg_color',
											'label' => __('Search form background color', 'W2DC'),
											'default' => get_option('w2dc_search_bg_color'),
											'binding' => array(
												'field' => 'w2dc_color_scheme',
												'function' => 'w2dc_affect_setting_w2dc_search_bg_color'
											),
										),
										array(
											'type' => 'slider',
											'name' => 'w2dc_search_bg_opacity',
											'label' => __('Opacity of search form background, in %', 'W2DC'),
											'min' => '0',
											'max' => '100',
											'default' => get_option('w2dc_search_bg_opacity'),
										),
										array(
											'type' => 'color',
											'name' => 'w2dc_search_text_color',
											'label' => __('Search form text color', 'W2DC'),
										...
										array(
											'type' => 'toggle',
											'name' => 'w2dc_search_overlay',
											'label' => __('Use overlay on search form', 'W2DC'),
											'default' => get_option('w2dc_search_overlay'),
										),
									),
								),
								'misc_colors' => array(
									...
									'fields' => array(
										...
										array(
											...
											'label' => __('jQuery UI Style', 'W2DC'),
									 		'description' =>  __('Controls the color of calendar, dialogs and slider UI widgets', 'W2DC'),
									 		'items' => array(
									 			array(
									 				'value' => 'blitzer',
									 				'label' => 'Blitzer',
