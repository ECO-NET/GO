...
div.w2dc-content .wpcf7-form .wpcf7-submit:focus {
	...
	border-color: <?php echo w2dc_adjust_brightness(w2dc_get_dynamic_option('w2dc_button_1_color'), -20); ?>;
}
...
div.w2dc-content .wpcf7-form .wpcf7-submit:hover {
	...
	background-image: none;
	border-color: <?php echo w2dc_adjust_brightness(w2dc_get_dynamic_option('w2dc_button_2_color'), -20); ?>;
...
<?php if (!w2dc_get_dynamic_option('w2dc_search_overlay')): ?>
.w2dc-search-overlay {
	background: none;
}
<?php endif; ?>
<?php if (w2dc_get_dynamic_option('w2dc_search_bg_color')): ?>
.w2dc-content.w2dc-search-form {
	background: <?php echo w2dc_hex2rgba(w2dc_get_dynamic_option('w2dc_search_bg_color'), w2dc_get_dynamic_option('w2dc_search_bg_opacity')/100); ?>;
}
<?php endif; ?>
