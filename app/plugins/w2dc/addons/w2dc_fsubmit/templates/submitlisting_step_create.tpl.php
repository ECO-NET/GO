<div class="w2dc-content">
	...
	<h3><?php echo sprintf(apply_filters('w2dc_create_option', __('Submit new %s in level "%s"', 'W2DC'), $w2dc_instance->current_listing), $directory->single, $w2dc_instance->current_listing->level->name); ?></h3>
	<?php endif; ?>
